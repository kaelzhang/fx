...
function Frames(options, startNow) {
...
util.inherits(Frames, EventEmitter);


Frames.prototype.step = function(now) {
    var self = this;
...
Frames.prototype.cancel = function() {
    var self = this;
    if (self.isRunning()) {
        self.time = null;
        clock.removeFx(self);
...
Frames.prototype.resume = function() {
    var self = this;
...
Frames.prototype.isRunning = function() {
